...
In this particular scenario, it seems like Matthew's new approximation works quite well. However, an important caveat to this is that the greedy initialization appears to work very poorly for this approximation.
