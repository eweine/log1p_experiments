...
previous results in one important respect: previous results in one
important respect: the "ethanol factor" does not contribute much to
the RA samples.

```{r structure-plot-log1pNMF-c01, fig.height=2.25, fig.width=5}
topic_colors <- c("olivedrab","dodgerblue","darkblue","tomato")
L <- fit_log1p_c0.1$LL
d <- apply(L,2,quantile,probs = 0.75)
L <- scale_cols(L,1/d)
